	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-md-12 ftco-animate text-center">
	              <h1 class="mb-2">Home  Foods</h1>
	              <h2 class="subheading mb-4">like mom's food </h2>
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-sm-12 ftco-animate text-center">
	              <h1 class="mb-2">100% fresh and nutrition food</h1>
	              <h2 class="subheading mb-4">you can order online your lunch</h2>
    ...
    <section class="ftco-section">
								...
								<div class="category-wrap-2 ftco-animate img align-self-stretch d-flex" style="background-image: url(images/category.jpg);">
									<div class="text text-center">
										...
										<p>Protect the health of every home</p>
										 <p><a href="order.jsp" class=" btn btn-primary" style="font-size:30px;hight:320px;width:320px;"><b>-Order now -</b></a></p> 
									</div>
								</div>
							</div>
							<div class="col-md-6">
    	...
    	<div class="container">
          ...
          <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
            ...
            <h3><a href="#">For more than 10 lunch packets</a></h3>
            <span class="price"> Rs 300.00   <a href="#">now Rs 250.00 only</a></span>
