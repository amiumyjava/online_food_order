			...
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/about.jpg);">
						<a href="https://www.youtube.com/watch?v=zjJBh4a5BeQ" class="icon popup-vimeo d-flex justify-content-center align-items-center">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Welcome to Sanras Holiday Home's online food ordering website</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>The Foods Standards Agency defines a balanced diet as having 
                            ?a variety of foods, basing meals on starchy foods and eating at least 5 portions of fruit and veg a day.?
                            They also recommend having moderate amounts of fish (2 portions a week one being oily) moderating the amount
                            of protein you have and having small or occasional amounts of food high in fat or sugar.

                         <h6>The importance of nutrition and a balanced diet</h6>
                         <p>  Nutrition is vital for your body and all of its systems to function properly, 
                           by having good nutrition it will help you maintain a healthy weight, reduce body fat, 
                           provide your body with energy, promote good sleep and generally make you feel better.</p>
							</p>
							 <p><a href="order.jsp" class=" btn btn-primary" style="font-size:40px;hight:520px;width:520px;"><b>-Order now -</b></a></p> 
						</div>
					</div>
				</div>
			</div>
